...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/" class="logo">
      ...
      <span class="logo-lg"> <img src="${pageContext.request.contextPath }/resources/dist/img/muf.png"/> </span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="${pageContext.request.contextPath }/resources/dist/img/0.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Yana Maulana</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                <img src="${pageContext.request.contextPath }/resources/dist/img/0.jpg" class="img-circle" alt="User Image">
...
<%--          <li><a href="${pageContext.request.contextPath }/admin/master/user"><i class="fa fa-circle-o"></i> User</a></li> --%>
        ...
        <li><a href="/"><i class="fas fa-user">&nbsp&nbsp&nbsp</i>User</a></li>
        <li><a href="${pageContext.request.contextPath }/asset"><i class="fas fa-box">&nbsp&nbsp&nbsp</i> Asset</a></li>
...
<!--         <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Information</span></a></li> -->
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright 2019 <a href="https://adminlte.io">Yanamaulana45@yahoo.co.id</a>.</strong> All rights
    reserved.
  </footer>
